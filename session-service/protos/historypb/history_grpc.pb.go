...
const (
	History_GetBySessionID_FullMethodName = "/session.history.service.History/GetBySessionID"
)
...
type HistoryClient interface {
	GetBySessionID(ctx context.Context, in *GetBySessionIDRequest, opts ...grpc.CallOption) (*SessionHistoryResponse, error)
}
...
func (c *historyClient) GetBySessionID(ctx context.Context, in *GetBySessionIDRequest, opts ...grpc.CallOption) (*SessionHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionHistoryResponse)
	err := c.cc.Invoke(ctx, History_GetBySessionID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HistoryServer interface {
	GetBySessionID(context.Context, *GetBySessionIDRequest) (*SessionHistoryResponse, error)
...
func (UnimplementedHistoryServer) GetBySessionID(context.Context, *GetBySessionIDRequest) (*SessionHistoryResponse, error) {
...
func _History_GetBySessionID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBySessionIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HistoryServer).GetBySessionID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: History_GetBySessionID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HistoryServer).GetBySessionID(ctx, req.(*GetBySessionIDRequest))
	}
...
var History_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "session.history.service.History",
	HandlerType: (*HistoryServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetBySessionID",
			Handler:    _History_GetBySessionID_Handler,
		},
	},
