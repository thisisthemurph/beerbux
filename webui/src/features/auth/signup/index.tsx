...
function SignupPage() {
	...
	async function handleSignup({ name, username, email, password, verificationPassword }: SignupFormValues) {
		try {
			await signup(name, username, email, password, verificationPassword);
